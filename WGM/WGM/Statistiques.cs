...
namespace Statistiques
{
    public partial class uscStats: UserControl
    {
        ...
        private void MenuDeroulant(object sender,Panel P,String T,int hauteur)
        {
        ...
        {
            MenuDeroulant(sender, pnlParCaserne, "Statistiques par Caserne",450);
        }

        private void btnInterCaserne_Click(object sender, EventArgs e)
        {
            MenuDeroulant(sender, pnlInterCaserne, "Statistiques inter-Caserne", 650);
        }
        ...
        private void uscStats_SizeChanged(object sender, EventArgs e)
        {
            lblStats.Left= (this.Width-lblStats.Width)/2;
        }
    }
}
